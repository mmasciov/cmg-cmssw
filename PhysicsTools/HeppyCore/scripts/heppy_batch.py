...
gfal-mkdir {srm}
#echo "gfal-copy file://`pwd`/Loop/mt2.root {srm}/mt2_{idx}.root"
#gfal-copy file://`pwd`/Loop/mt2.root {srm}/mt2_{idx}.root
echo "lcg-cp `pwd`/Loop/mt2.root {srm}/mt2_{idx}.root"
lcg-cp `pwd`/Loop/mt2.root {srm}/mt2_{idx}.root
if [ $? -ne 0 ]; then
...
#      echo "gfal-copy file://`pwd`/$f.root {srm}/${{ff}}_{idx}.root"
#      gfal-copy file://`pwd`/$f.root {srm}/${{ff}}_{idx}.root
#      if [ $? -ne 0 ]; then
#         echo "ERROR: remote copy failed for file $ff"
#      else
#         echo "remote copy succeeded"
